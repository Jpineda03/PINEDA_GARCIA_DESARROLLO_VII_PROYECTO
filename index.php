...
<body>
  ...
  <div id="detalle" class="open detalle row">
    ...
    <div class="componente_receta row" >
      ...
      <img class="recetas_imagen" src='.\assets\images\receta_presentacion.png' class="shadow" height="100%">
      ...
      <div class="componente_receta_contenedor_der col" style="position: relative;">
        ...
        <div class="componente_receta_contenedor_der_sup col">
          ...
          <div class="componente_receta_descripcion">
            ...
            cumque sed quidem. Incidunt, provident possimus error magnam eligendi totam id repudiandae ratione quisquam
            libero non. Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt nesciunt facere quo temporibus
