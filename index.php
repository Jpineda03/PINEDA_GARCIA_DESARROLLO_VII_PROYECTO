<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="contenedor-principal">
      ...
      <div id='elemente_1' class="contenedor-izquierdo open" style="background-image: url('./assets/images/receta_presentacion.png'); background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="contenedor-derecho">
        <div class='main_container'>
          ...
          <div onclick='toggle_element("detalle")' class='receta' style='background-image: url("assets/images/image-animal.jpg");'> 
    ...
    <div id="detalle" class="open detalle row">
        ...
        <div class="detalle_receta_detalles col" style="position: relative;">
          ...
          <div class="contenedor_detalles_inf col">
            ...
            <div class="contenedor_detalles_inf_opciones row">
              ...
              <svg style='display:${not_print_agregar}' id='agregar_favorito_${my_book_id}' onclick="agregar_favorito('${titulo_receta}', '${descripcion}','${imagen}', '${autor}', '${my_book_id}', '${my_book_id}')" class="clickeable" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
